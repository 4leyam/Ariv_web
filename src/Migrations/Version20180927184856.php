 ...
 */
final class Version20180927184856 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_4808100057108F2A ON nzela_user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX UNIQ_4808100057108F2A ON nzela_user (id_agence_id)');
    }
}
